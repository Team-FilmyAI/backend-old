...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<?> handleDatabaseError(DataAccessException ex) {
        return new ResponseEntity<>(buildResponse("Database error occurred", HttpStatus.INTERNAL_SERVER_ERROR), HttpStatus.INTERNAL_SERVER_ERROR);
    }

    @ExceptionHandler(NullPointerException.class)
    public ResponseEntity<?> handleNullPointer(NullPointerException ex) {
        return new ResponseEntity<>(buildResponse("Unexpected missing data", HttpStatus.INTERNAL_SERVER_ERROR), HttpStatus.INTERNAL_SERVER_ERROR);
    }
