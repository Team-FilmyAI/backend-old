...
//
//		List<Project> projects = Optional.ofNullable(projectRepository.findAllWithJobs()).orElse(List.of());
//
...
//
//		return JobResponseDto.builder().jobId(job.getJobId())
//				.roleName(job.getRole() != null ? job.getRole().getRoleName() : null)
//				.characterDescription(actor != null ? actor.getCharDescription() : null)
//				.minAge(actor != null ? actor.getMinAge() : null).maxAge(actor != null ? actor.getMaxAge() : null)
//				.gender(actor != null && actor.getGender() != null ? actor.getGender().getGenderName() : null)
//				.ethnicity(
//						actor != null && actor.getEthnicity() != null ? actor.getEthnicity().getEthnicityName() : null)
...
//				.postedAt(job.getPostedAt()).build();
//	}
